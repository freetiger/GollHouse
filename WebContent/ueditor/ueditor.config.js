...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:window.UEDITOR_UPLOAD_URL                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,imageManagerPath:window.UEDITOR_UPLOAD_URL                                 //图片修正地址，同imagePath
        ...
        , toolbars: [["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","searchreplace","preview","insertimage","emotion","date","time","bold","italic","underline","strikethrough","forecolor","justifyleft","justifycenter","justifyright","justifyjustify"],[]]
